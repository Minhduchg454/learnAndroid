...
fun LunchTrayApp(
    ...
    // TODO: Create Controller and initialization
        //Cac bien ho tro dieu huong
    val navController: NavHostController = rememberNavController()

        //Cac bien ho tro quay ve man hinh truoc do
        ...
        NavHost(
            ...
            composable(route = LunchTrayScreen.EntreeMenu.name){
                ...
                EntreeMenuScreen(
                    ...
                    modifier = Modifier
                        .verticalScroll(rememberScrollState())//Them thanh cuon doc trong man hinh ung va ghi nhi vi tri cuon cua nguoi dung
...
private fun cancelOrderAndNavigateToStart(
    ...
    //Loai bo tat ca cac man hinh trong ngan xep cho den khi gap man hinh start thi khong xoa nua, khi inclusive la false
    //Neu inclusive la true, thi xoa sach cac phan tu trong ngan xep thi chi giu lai phan tu sau cung
}
